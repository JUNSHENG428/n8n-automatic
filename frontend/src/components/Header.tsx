      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">n8n 工作流生成器</h1>
              <p className="text-sm text-gray-600 dark:text-gray-400">使用 AI 将需求转化为自动化工作流</p>
            </div>
          </div>
